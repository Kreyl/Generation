...
#define BIO_ENABLE(abil_, ...) \
        (SET_BIT_K(BIO##__VA_ARGS__.Abilities, abil_##_SIG - FIRST_ABILITY))
#define BIO_DISABLE(abil_, ...) \
        (CLEAR_BIT_K(BIO##__VA_ARGS__.Abilities, abil_##_SIG - FIRST_ABILITY))
#define BIO_PWR_ENABLE(abil_, ...) \
        (SET_BIT_K(BIO##__VA_ARGS__.Power, abil_##_SIG - FIRST_ABILITY))
#define BIO_PWR_DISABLE(abil_, ...) \
        (CLEAR_BIT_K(BIO##__VA_ARGS__.Power, abil_##_SIG - FIRST_ABILITY))
#define BIO_IS_ABLE(abil_)     (CHECK_BIT_K(BIO.Abilities, abil_ - FIRST_ABILITY))
#define BIO_IS_PWR_ABLE(abil_) (CHECK_BIT_K(BIO.Power, abil_ - FIRST_ABILITY))
